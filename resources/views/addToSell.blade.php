...
<?php
    ...
    $headline = $username." এর সকল অর্ডারের লিস্ট";
    $headline2 = $username." এখনো কোন অর্ডার করে নাই";

    $linkconfirm = "conformsellorder/".$uid;
    $linkupdate = "updatesellorder/".$uid;
?>

<!-- Java Script Part for Search -->

<title>Order Item to Sell</title>
...
<div class="container">
    <div class="row">
            ...
            <?php echo $linkconfirm; ?> >Confirm</a></button>
            <?php
            }else{
            ?>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <button type="submit" name="submit" id="updatesellorder" value="updatesellorder" class="btn btn-default" style="text-align:center;">Submit</button>
                        </div>
                        </div>
                        </form>
                    </div>
