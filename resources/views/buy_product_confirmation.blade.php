...
<?php
  $userid = $uid;
    ...
    $headline = "ক্রয়ের সকল হিসাব কনফার্ম করুণ [মহাজন: ".$username;
    $headline = $headline."]";
?>
...
<div class="container">
<div class="row">
  <form role="form" method="POST" action="buyitemconfirm" style="background-color:#E6E6FA;padding:10px;width: 100%">
    ...
    <button type="submit" name="submit" id="buyitemconfirm" value="buyitemconfirm" class="btn btn-default" style="text-align:center;">Confirm</button>
  </form>
  </div>
</div>
